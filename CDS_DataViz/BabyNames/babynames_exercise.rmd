...
<meta content="origin-when-cross-origin" name="referrer" />
  ...
  <title>DV_NYU_course_material/babynames_exercise.Rmd at master · DS-GA3001-015/DV_NYU_course_material</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjM4OTAwMTI4Ojk4OGIzMTRhOGY1ZTkyMzE1ZWIzZjU3Y2IyY2NjZDBhNDQwODc3MTg0YmQ0OTQwMWE0ODgxYzY3NTkxZTI3ZGM=--f433ee6bdedd2e917fbfadad62e22372edf5a150">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="D36F:EBE2:2723326:485202D:5A75F359" data-pjax-transient>
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="rxl204">
    ...
    <meta name="js-proxy-site-detection-payload" content="MDk2YjQ2Nzk5OTI1OTJkMzVmYmIzMTRiMTk2MmM0NmZiMTIwMmJlMmU2ZWUzZGIyOTk5Njg1NjEyOGQ5MjUyZXx7InJlbW90ZV9hZGRyZXNzIjoiNDcuMTcuNC4yNTQiLCJyZXF1ZXN0X2lkIjoiRDM2RjpFQkUyOjI3MjMzMjY6NDg1MjAyRDo1QTc1RjM1OSIsInRpbWVzdGFtcCI6MTUxNzY3OTQ1MiwiaG9zdCI6ImdpdGh1Yi5jb20ifQ==">
  ...
  <meta http-equiv="x-pjax-version" content="2bcdfdf37090b189cdf7cd792d535310">
      ...
      <link href="https://github.com/DS-GA3001-015/DV_NYU_course_material/commits/master.atom?token=AeLCPWB7MztqHPXKdgCwbfgVBdoQ0xuNks64gdRcwA%3D%3D" rel="alternate" title="Recent Commits to DV_NYU_course_material:master" type="application/atom+xml">
  ...
  <meta content="35733679" name="octolytics-dimension-user_id" /><meta content="DS-GA3001-015" name="octolytics-dimension-user_login" /><meta content="118624917" name="octolytics-dimension-repository_id" /><meta content="DS-GA3001-015/DV_NYU_course_material" name="octolytics-dimension-repository_nwo" /><meta content="false" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="118624917" name="octolytics-dimension-repository_network_root_id" /><meta content="DS-GA3001-015/DV_NYU_course_material" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
    ...
    <link rel="canonical" href="https://github.com/DS-GA3001-015/DV_NYU_course_material/blob/master/Lectures/Week01/babynames/babynames_exercise.Rmd" data-pjax-transient>
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/DS-GA3001-015/DV_NYU_course_material/search" class="js-site-search-form" data-scoped-search-url="/DS-GA3001-015/DV_NYU_course_material/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/DS-GA3001-015/DV_NYU_course_material/blob/master/Lectures/Week01/babynames/babynames_exercise.Rmd" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      ...
      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="wKVBuueKBqeMRjXi95wjVZ6EgMVydJK0KrjpUzWrwvmZjhfLFvYWJrLWK+x6eCU5mr99kuoJJdujIrKamzw+EA==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="YXB611BkDapcmcEhKZ7DNxEA4Hzb0hLSpKgcJ/v3Nvc4WyymoRgdK2IJ3y+kesVbFTsdK0Ovpb0tMkfuVWDKHg==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="2Yt80seYmW4ZGrRRSTZcq7esbm6WOwlZPkOZuDh29pOoJK/caTGwKp18gq4OYsXrDQxMAJ3svpJBOBm15DQsGg==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="118624917" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/DS-GA3001-015/DV_NYU_course_material/unstar" class="starred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="gAMjI2eO90scYoR67k37XHYV0MqtKjQXKsdimaBl/ZV2iuq2Ksny5v6xwA55K/7jNSJfs8ZuU3mToADCJffQZA==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/DS-GA3001-015/DV_NYU_course_material/star" class="unstarred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="siCCUgKRf6vUw+Zl/0Z8V0w4yjGD/2muzlXl/IIsn+9MdySiiDHNXHbT/XU7AVe/Ic48lA2Bl8zJ1GnFa4mdgQ==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <span class="author" itemprop="author"><a href="/DS-GA3001-015" class="url fn" rel="author">DS-GA3001-015</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a href="/DS-GA3001-015/DV_NYU_course_material" data-pjax="#js-repo-pjax-container">DV_NYU_course_material</a></strong>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a href="/DS-GA3001-015/DV_NYU_course_material/blob/1a9da641e86c5e987b2ddc8426030ffbddb88994/Lectures/Week01/babynames/babynames_exercise.Rmd" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:9b4b989ae48f6696bb7a1dfa1dbc576f -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/DS-GA3001-015/DV_NYU_course_material/blob/master/Lectures/Week01/babynames/babynames_exercise.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/DS-GA3001-015/DV_NYU_course_material/raw/master/Lectures/Week01/babynames/babynames_exercise.Rmd" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/DS-GA3001-015/DV_NYU_course_material/blame/master/Lectures/Week01/babynames/babynames_exercise.Rmd" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/DS-GA3001-015/DV_NYU_course_material/commits/master/Lectures/Week01/babynames/babynames_exercise.Rmd" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/DS-GA3001-015/DV_NYU_course_material/edit/master/Lectures/Week01/babynames/babynames_exercise.Rmd" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="3Is9Y+NZvXkOR5HQBriAZkrXuG4aGf0t6kxiLuze+Qhf4DRZ565WJeyPABLiEZZ27E86nvOISZZVDgDBcbTdGg==" /></div>
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/DS-GA3001-015/DV_NYU_course_material/delete/master/Lectures/Week01/babynames/babynames_exercise.Rmd" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="TIkuNv0X4DUEkEKDrCZHITfUtPxsTdeATO+EVm8uk64FjLRHuq5/kBHOFs7c9RLPhtcc7fAr/U7Ev3XzB6k0KA==" /></div>
...
<pre lang="{r,"><code>knitr::include_graphics("baby-names-wordcloud.jpg")
</code></pre>
...
<pre lang="{r,"><code>library(babynames)
</code></pre>
<p>And while we are at it, let's load a few more necessary and helpful packages.</p>
<pre lang="{r,"><code>library(ggplot2)    # the king of plotting 
...
<pre lang="{r}"><code>head(babynames)
</code></pre>
...
<pre lang="{r}"><code>tail(babynames)
</code></pre>
...
<pre lang="{r}"><code># How many unique names?
...
<pre lang="{r,"><code>ggplot(babynames, aes(year, n)) +
...
<pre lang="{r}"><code>head(filter(babynames, name=="James"))
...
<pre lang="{r,"><code>library(magrittr)  
...
<pre lang="{r,"><code># Try to follow this code chunk at home, using dplyr() and magrittr()
top10 &lt;- babynames %&gt;%
  group_by(sex, name) %&gt;%
...
<pre lang="{r,"><code>top10 &lt;- babynames %&gt;%
  group_by(sex, name) %&gt;%
  summarize(total = sum(n)) %&gt;%
  arrange(desc(total)) %&gt;%
  group_by(sex) %&gt;%
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.15612s from unicorn-1417999911-fxnlz">GitHub</span>, Inc.</li>
